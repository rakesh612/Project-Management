...
export const createproject = async(req,res)=>{
    try {
        const {userId}=await req.auth();  //from clerk
        ...
        const workspace = await prisma.workspace.findUnique({
            ...
            include:{members:{include:{user:true}}}  //it will add the user data in this workspace
        })
        ...
        if(!workspace.members.some((member)=>member.userId===userId && member.role==="ADMIN"))  //checking if user is not admin
        {
